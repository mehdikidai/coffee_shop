<x-layout title="Setting Page" name_page="setting mb-4">
    ...
    <form action="{{ route('setting.update') }}" method="POST" class="mt-4">
        ...
        <ul class="list-group list-group-flush" data-bs-theme="dark">
            <li class="list-group-item bg-transparent text-capitalize">
                <div class="input-group-sm">
                    <label for="site_name" class="form-label"> {{ __('t.site_name') ?? "site name" }} </label>
            ...
            <li class="list-group-item bg-transparent text-capitalize">
                <div class="input-group-sm">
                    <label for="site_email" class="form-label"> {{ __('t.site_email') ?? "site email" }} </label>
            ...
            <li class="list-group-item bg-transparent text-capitalize">
                <div class="input-group-sm">
                    <label for="daily_expected_income" class="form-label"> {{ __('t.daily_expected_income') ?? "daily expected income" }} </label>
            ...
            <li class="list-group-item bg-transparent text-capitalize">
                <div class="mb-1 input-group-sm">
                    <label for="currency" class="form-label"> {{ __('t.currency') ?? "currency" }} </label>
